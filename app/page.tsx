...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-900 font-sans relative bg-gradient-to-b from-[#f4f7f5] via-[#eef5f2] to-[#faf8f5] selection:bg-emerald-900 selection:text-emerald-100 overflow-hidden">
      ...
      {/* Dynamic Animated Ambient Gradient Blobs */}
      ...
      <header className="sticky top-0 z-40 backdrop-blur-2xl bg-white/70 border-b border-emerald-900/10 shadow-[0_4px_30px_rgba(6,78,59,0.04)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-extrabold tracking-widest text-emerald-800 uppercase bg-emerald-100/70 border border-emerald-300/60 px-2 py-0.5 rounded-full">
              Detailing
            </span>
          </div>
      ...
      <section className="relative pt-12 sm:pt-20 pb-24 sm:pb-36 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-emerald-100/90 via-teal-50/90 to-amber-100/90 border border-emerald-300/60 text-emerald-900 px-3.5 sm:px-5 py-2 rounded-full text-[11px] sm:text-xs font-bold mb-6 sm:mb-8 shadow-sm backdrop-blur-md">
            <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600 fill-emerald-600 shrink-0" /> 
            <span>100% Mobile Service — We Come To You!</span>
          </div>
          
          <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tight mb-6 sm:mb-8 leading-[1.08] sm:leading-[1.02] text-slate-900">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3.5 sm:gap-5 max-w-xs sm:max-w-none mx-auto">
            <a
              href="#services"
              className="w-full sm:w-auto bg-gradient-to-r from-emerald-800 via-teal-800 to-emerald-900 hover:from-emerald-700 hover:to-teal-700 text-amber-300 font-bold px-8 sm:px-10 py-3.5 sm:py-4.5 rounded-2xl transition-all duration-300 text-base sm:text-lg shadow-xl shadow-emerald-950/20 hover:-translate-y-1 flex items-center justify-center gap-2 group"
            >
              Explore Services
      ...
      <section id="about" className="py-16 sm:py-28 max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-slate-600 text-sm sm:text-lg max-w-lg mx-auto px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {/* Card 1 */}
          <div className="p-6 sm:p-8 bg-white/60 backdrop-blur-xl border border-white/80 rounded-3xl group transition-all duration-300 hover:border-emerald-500 hover:bg-white/80 hover:shadow-2xl hover:shadow-emerald-950/10 hover:-translate-y-1.5 relative overflow-hidden">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-tr from-emerald-800 to-teal-600 rounded-2xl flex items-center justify-center mb-5 sm:mb-6 shadow-lg shadow-emerald-900/20 text-amber-300">
              <Car className="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition-transform" />
            </div>
          ...
          {/* Card 2 */}
          <div className="p-6 sm:p-8 bg-white/60 backdrop-blur-xl border border-white/80 rounded-3xl group transition-all duration-300 hover:border-teal-500 hover:bg-white/80 hover:shadow-2xl hover:shadow-teal-950/10 hover:-translate-y-1.5 relative overflow-hidden">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-tr from-teal-800 to-cyan-700 rounded-2xl flex items-center justify-center mb-5 sm:mb-6 shadow-lg shadow-teal-900/20 text-cyan-200">
              <Anchor className="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition-transform" />
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-gradient-to-r from-emerald-950 via-teal-950 to-slate-950 border border-emerald-800/40 p-6 sm:p-10 md:p-16 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl shadow-emerald-950/20 text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-3.5 py-1.5 rounded-full text-[11px] sm:text-xs font-semibold text-amber-300 mb-6">
                <Sparkles className="w-3.5 h-3.5 text-amber-300" /> Premium Detailing Experience
              </div>
              <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-6 sm:mb-8">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 bg-white/10 backdrop-blur-xl border border-white/15 p-4 sm:p-6 md:p-8 rounded-2xl max-w-3xl mx-auto">
                <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto justify-center">
                  <div className="p-3 sm:p-4 bg-white/20 rounded-xl sm:rounded-2xl backdrop-blur-md border border-white/20 shrink-0">
                     <Phone className="w-5 h-5 sm:w-7 sm:h-7 text-amber-300" />
                  </div>
                  <div className="text-left">
                    <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-emerald-200">Call or Text</div>
                    <div className="font-extrabold text-lg sm:text-xl md:text-2xl text-white tracking-tight whitespace-nowrap">
                      (604) 782-9107
                    </div>
                  </div>
                </div>
